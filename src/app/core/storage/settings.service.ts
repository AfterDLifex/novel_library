...
const DEFAULT_SETTINGS: AppSettings = {
  ...
  // Gutendex is the default: it works directly from the browser (no proxy, no API key)
  // and provides actual readable full text — not just metadata.
  defaultSourceId: 'gutendex',
  enabledSourceIds: ['gutendex'],
